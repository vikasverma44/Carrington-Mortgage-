...
/// </summary>
public class NCPPipeCreatedByComposerModel
{
    ...
    public string IMBOrPostnet { get; set; }
    public char PLTType { get; set; }
    public int OriginMailTracking { get; set; }
    public int CertifiedMailAriticleNum { get; set; }
	...
	public string ClientIndicator2 { get; set; }
	public string ClientIndicator3 { get; set; }
	public string InserterCodeType { get; set; }
	public string PLTSuffixData { get; set; }
	public string InserterPageBarCodes { get; set; }
	public string RemitIMBPostnet { get; set; }
	public NCPPipeCreatedByComposerModel()
	{
