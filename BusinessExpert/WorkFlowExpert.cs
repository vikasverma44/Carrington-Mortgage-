    ...
    public class WorkFlowExpert : IWorkFlowExpert
    {
        ...
        public void GetTransactionRecordModel(byte[] currentByte, ref AccountsModel acc)
        {
            acc.TransactionRecordModel = new TransactionRecordModel()
            {
                ...
                Rssi_Tr_Amt_PackedData = GetPositionData(currentByte, 48, 13),
                Rssi_Tr_Cash_Amt_PackedData = GetPositionData(currentByte, 56, 13),
                ...
                Rssi_Tr_Amt_To_Ivar_PackedData = GetPositionData(currentByte, 104, 5),
                ...
                Rssi_Tr_Amt_To_Cr_Ins_PackedData = GetPositionData(currentByte, 126, 2),
                ...
                Rssi_Tr_Prn_Var_PackedData = GetPositionData(currentByte, 152, 4),
                ...
                Rssi_Tr_Exp_Fee_Amt_PackedData = GetPositionData(currentByte, 318, 8),
