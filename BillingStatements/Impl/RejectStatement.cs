        ...
        public bool IsRejectAccount(AccountsModel accountModel)
        {
            try
            {
                ...
                if (((accountModel.ActiveBankruptcyInformationRecordModel.Rssi_B_Chap == "07" || accountModel.ActiveBankruptcyInformationRecordModel.Rssi_B_Chap == "11")
                    ...
                    && accountModel.ArchivedBankruptcyDetailRecordModel.Any(m => m.Rssi_K_B_Reaffirm_Dt_PackedData == "000000"))
                    //|| accountModel.UserFieldRecordModel.Rssi_Usr_93 == "7" || accountModel.UserFieldRecordModel.Rssi_Usr_93 == "11")
                    //&& accountModel.BlendedRateInformationRecordModel.Rssi_Ml_Alt_Typ_Id == "O"
                ...
                else if (((accountModel.ActiveBankruptcyInformationRecordModel.Rssi_B_Chap == "07" || accountModel.ActiveBankruptcyInformationRecordModel.Rssi_B_Chap == "11")
                  && accountModel.BlendedRateInformationRecordModel.Rssi_Ml_Alt_Typ_Id != "O"
                  && accountModel.ArchivedBankruptcyDetailRecordModel.Any(m => m.Rssi_K_B_Reaffirm_Dt_PackedData == "000000"))
                  //|| (accountModel.UserFieldRecordModel.Rssi_Usr_93 == "7" || accountModel.UserFieldRecordModel.Rssi_Usr_93 == "11")
                  //&& accountModel.BlendedRateInformationRecordModel.Rssi_Ml_Alt_Typ_Id != "O" 
